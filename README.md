...
| **CLI**        | Scriptable PPTX split/build/verify, manifest-driven DOCX build/compare/consolidate, DOCX assembly/cleanup/validation/HTML conversion, and XLSX create/verify workflows with text or JSON output |
