...
/// <summary>
/// Unit tests for <see cref="StringExtensions.SplitAndKeep"/>.
/// </summary>
public class StringExtensionsTests
{
    ...
    [Test]
    public async Task SSK001_NullString_ReturnsEmptyList()
    {
        string? s = null;
    ...
    [Test]
    public async Task SSK002_EmptyString_ReturnsEmptyList()
    {
    ...
    [Test]
    public async Task SSK003_NoDelimiterInString_ReturnsSingleElement()
    {
    ...
    [Test]
    public async Task SSK004_SingleDelimiterMidString_SplitsAndKeepsDelimiter()
    {
        var result = "a\nb".SplitAndKeep('\n');
    ...
    [Test]
    public async Task SSK005_DelimiterAtStart_KeepsDelimiterBeforeContent()
    {
        var result = "\nhello".SplitAndKeep('\n');
    ...
    [Test]
    public async Task SSK006_DelimiterAtEnd_KeepsDelimiterAfterContent()
    {
        var result = "hello\n".SplitAndKeep('\n');
        await Assert.That(result).IsEquivalentTo(["hello", "\n"]);
    }
    ...
    [Test]
    public async Task SSK007_ConsecutiveDelimiters_EachDelimiterIsOwnElement()
    {
        var result = "a\n\nb".SplitAndKeep('\n');
        await Assert.That(result).IsEquivalentTo(["a", "\n", "\n", "b"]);
    }
    ...
    [Test]
    public async Task SSK008_MultipleDelimiterChars_SplitsOnEach()
    {
        var result = "a\tb\nc".SplitAndKeep('\n', '\t');
    ...
    [Test]
    public async Task SSK009_StringConsistingOnlyOfDelimiter_ReturnsSingleDelimiterElement()
    {
        var result = "\n".SplitAndKeep('\n');
        await Assert.That(result).IsEquivalentTo(["\n"]);
    }
    ...
    [Test]
    public async Task SSK010_StringWithNoMatchForDelimiters_ReturnsSingleElement()
    {
        var result = "no tab here".SplitAndKeep('\t');
        await Assert.That(result).IsEquivalentTo(["no tab here"]);
    }
}
